-- ============================================================
-- 031 — Adicionar seções customizadas ao get_public_report
-- ============================================================
...
RETURNS json AS $$
  SELECT json_build_object(
    ...
    'custom_section_values', (SELECT coalesce(json_agg(row_to_json(csv)), '[]'::json) FROM custom_section_values csv WHERE csv.attendance_id = a.id)
  )
  FROM attendances a
